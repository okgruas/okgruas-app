...
# 2. ESTILO VISUAL "NEÓN RS" + PARCHE DE IMPRESIÓN PRO
st.markdown("""
    <style>
    ...
    /* PARCHE PARA IMPRESIÓN - FUERZA EL NEGRO EN LA HOJA */
    @media print {
        ...
        .stMarkdown, .stExpander { color: #00FF00 !important; }
    }
    </style>
